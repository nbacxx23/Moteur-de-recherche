...
/**
 * A simple Search Engine(simple tokenization).
...
public class SearchEngine {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            ArrayList<String> keyList = tokenizerNoStopWords.normalize(keyWordR);
        ...
        scoreDoc = Similarity.getSimilarDocuments(keyWords,relativeFilesSet,df,doc,tokenizerNoStopWords);
